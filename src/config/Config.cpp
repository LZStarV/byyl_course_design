...
{
    if (envFlag("LEXER_SKIP_LINE_COMMENT", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_line_comment").toBool(true);
            }
        }
    }
    return false;
...
{
    if (envFlag("LEXER_SKIP_BLOCK_COMMENT", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_block_comment").toBool(true);
            }
        }
    }
    return false;
...
{
    if (envFlag("LEXER_SKIP_SQ_STRING", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_single_quote_string").toBool(true);
            }
        }
    }
    return false;
...
{
    if (envFlag("LEXER_SKIP_DQ_STRING", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_double_quote_string").toBool(true);
            }
        }
    }
    return false;
...
{
    if (envFlag("LEXER_SKIP_TPL_STRING", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_template_string").toBool(true);
            }
        }
    }
    return false;
...
{
    if (envFlag("LEXER_SKIP_HASH_COMMENT", true))
        return true;
    QString appDir   = QCoreApplication::applicationDirPath();
    QString cfgPath1 = appDir + "/../../config/lexer.json";
    QString cfgPath2 = appDir + "/config/lexer.json";
    ...
    if (!usePath.isEmpty())
    {
        ...
        if (f.open(QIODevice::ReadOnly | QIODevice::Text))
        {
            ...
            {
                auto obj = doc.object();
                return obj.value("skip_hash_comment").toBool(true);
            }
        }
    }
    return true;
